...
namespace E_Commerce_Mezzex.Migrations
{
    ...
    [Migration("20240619082808_Add Initial Migration 3")]
    partial class AddInitialMigration3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("E_Commerce_Mezzex.Models.Domain.RelatedProduct", b =>
                {
                    ...
                    b.Property<int>("RelatedProductDetailsId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RelatedProductDetailsId");
            ...
            modelBuilder.Entity("E_Commerce_Mezzex.Models.Domain.RelatedProduct", b =>
                {
                    ...
                    b.HasOne("E_Commerce_Mezzex.Models.Domain.Product", "RelatedProductDetails")
                        .WithMany()
                        .HasForeignKey("RelatedProductDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
